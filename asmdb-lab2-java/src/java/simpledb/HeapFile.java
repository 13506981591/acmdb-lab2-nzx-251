        ...
        public boolean hasNext() throws DbException, TransactionAbortedException
         {
            ...
            //to search next page
            index++;
            if (index<this.heapFile.numPages())
             {
                this.tupleIterator = get_TupleIterator(index);
                return true;
            }
            //the last page has been read, reset the index as this.heapFile.numPages
            index = this.heapFile.numPages();
            return false;
        }
